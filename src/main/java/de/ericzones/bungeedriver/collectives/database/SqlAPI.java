// Created by Eric B. 17.05.2021 17:38
...
public class SqlAPI {
    ...
    public SqlAPI(String host, int port, String database, String username, String password) {
        this.instance = BungeeDriver.getInstance();
        this.host = host;
        this.port = port;
    ...
    public void setInt(BungeeDriver instance, String database, String search, String getLine, int i, String line) {
        executorService.execute(() -> {
            update("UPDATE "+database+" SET "+line+"= '"+i+"' WHERE "+search+"= '"+getLine+"';");
        });
    }

    public void setString(BungeeDriver instance, String database, String search, String getLine, String i, String line) {
        executorService.execute(() -> {
            update("UPDATE "+database+" SET "+line+"= '"+i+"' WHERE "+search+"= '"+getLine+"';");
        });
    }
